...
public class PersistenceTest extends MongoDbTestBase {
    ...
    void setUp(){
        ...
        StepVerifier.create(repository.save(entity))
                .expectNextMatches(createdEntity -> {
                    ...
                    return areProductEqual(savedEntity, entity);
                })
                .verifyComplete();
    }
    ...
    void create(){
        ...
        StepVerifier.create(repository.findById(newEntity.getId()))
                ...
                //.expectNextMatches(foundEntity -> newEntity.getVersion() == foundEntity.getVersion())
                .verifyComplete();
...
//    }
    ...
    private boolean areProductEqual(ProductEntity expectedEntity, ProductEntity actualEntity){
        log.info("Id is {}/{}, version is {}/{}, name is {}/{}, productId is {}/{}",expectedEntity.getId(), actualEntity.getId(),
            expectedEntity.getVersion(), actualEntity.getVersion(),
                expectedEntity.getName(), actualEntity.getName(),
